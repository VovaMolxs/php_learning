        ...
        <div class='border border-2 rounded-5 border-success m-2 p-3  shadow-lg text-center'>
            <div class='item_chapter me-5'>
                <div class='item_chapter'>
                    <img width="25px" src='http://<?=$_SERVER['HTTP_HOST'] ?>/app/views/icon/<?php echo $art['categories_image'] ?>' alt='img_chapter'>
                    <p class="text-success"><span>Название категории: <?php echo $art['name'] ?></span></p>
                </div>
                <div class='item_author'>
                    <img width="25px" src='http://<?=$_SERVER['HTTP_HOST'] ?>/app/views/icon/2.png' alt='img_author'>
            ...
            <div class='item_img'>
                <img class='img' src='http://<?=$_SERVER['HTTP_HOST'] ?>/app/views/img/<?php echo $art['link_image'] ?>' alt=''>
            </div>
        </div>
    </div>
<?php endforeach; ?>
